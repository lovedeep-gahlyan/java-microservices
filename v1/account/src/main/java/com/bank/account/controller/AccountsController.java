...
public class AccountsController{
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CustomerDto> fetchAccountDetails(@RequestParam  @Pattern(regexp = "(^$|[0-9]{10})",message = "Mobile no must be 10 digits") String mobileNumber){
    ...
    public ResponseEntity<ResponseDto> deleteAccountDetails(@RequestParam @Pattern(regexp = "(^$|[0-9]{10})",message = "Mobile no must be 10 digits") String mobileNumber) {
